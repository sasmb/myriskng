  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="border-body-color/25 text-body-color mb-11 border-b pb-11 text-base leading-relaxed dark:border-white/25">
        Get the latest risk management insights, regulatory updates, and business continuity strategies delivered to your inbox. Stay informed about emerging risks affecting Nigerian businesses.
      </p>
      <div>
        <input
          type="text"
        ...
        <span className="absolute top-7 left-2">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#4bbdcd" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
